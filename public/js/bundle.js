...
exports.confirm = exports.showAlert = exports.hideAlert = void 0;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'data' ? 'api/v1/users/updateMyData' : 'api/v1/users/updatePassword';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
exports.deleteTour = exports.updateTour = exports.addTour = exports.addUser = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'User was added successfully');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Tour was added successfully');
            }
...
function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:3000/api/v1/tours/".concat(data.id),
              data: data
            });
  ...
  return function updateTour(_x3) {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Tour was successfully deleted');
              window.setTimeout(function () {
          ...
          case 10:
            ...
            (0, _alert.showAlert)('error', _context4.t0.response.tour.message);
...
var newUserData = document.querySelector('.form-new-user-data');
var updateTourForm = document.querySelector('.form-tour-data');
var deleteTourBtn = document.querySelector('.btn--red');
var addNewTourForm = document.querySelector('.form-addtour-data ');
...
if (newUserData) {
  ...
  newUserData.addEventListener('submit',
  /*#__PURE__*/
  function () {
    var _ref2 = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee2(e) {
      var name, email, role, photo, password, passwordConfirm;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              photo = document.getElementById('default.jpg').value;
...
if (updateTourForm) {
  console.log('should work');
  updateTourForm.addEventListener('submit',
  /*#__PURE__*/
  function () {
    var _ref3 = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee3(e) {
      ...
      var name, duration, maxGroupSize, difficulty, price, description, summary, id, selectedGuide, selectedGuide1, selectedGuide2, guide, guide1, guide2, guides;
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              maxGroupSize = document.getElementById('group-size').value;
              difficulty = document.getElementById('difficulty').value;
              price = document.getElementById('price').value;
              description = document.getElementById('description').value;
              summary = document.getElementById('summary').value;
              id = document.getElementById('id').value;
              selectedGuide = document.getElementById('guide-0');
              selectedGuide1 = document.getElementById('guide-1');
              selectedGuide2 = document.getElementById('guide-2');
              guide = selectedGuide.options[selectedGuide.selectedIndex].value;
              guide1 = selectedGuide1.options[selectedGuide1.selectedIndex].value;
              guide2 = selectedGuide2.options[selectedGuide2.selectedIndex].value;
              guides = [guide, guide1, guide2];
              console.log({
                name: name,
                duration: duration,
              ...
              _context3.next = 20;
              return (0, _admin.updateTour)((_updateTour = {
                name: name,
                maxGroupSize: maxGroupSize,
                duration: duration,
                guides: guides
              }, _defineProperty(_updateTour, "maxGroupSize", maxGroupSize), _defineProperty(_updateTour, "difficulty", difficulty), _defineProperty(_updateTour, "price", price), _defineProperty(_updateTour, "description", description), _defineProperty(_updateTour, "summary", summary), _defineProperty(_updateTour, "id", id), _updateTour));
...
if (addNewTourForm) {
  ...
  addNewTourForm.addEventListener('submit',
  /*#__PURE__*/
  function () {
    var _ref5 = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee5(e) {
      var name, startDates, guides, price, duration, maxGroupSize, difficulty, description, summary, imageCover;
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              e.preventDefault();
              name = document.getElementById('name').value;
              startDates = [document.getElementById('date-0').value, document.getElementById('date-1').value, document.getElementById('date-2').value];
              guides = [document.getElementById('guide-0').value, document.getElementById('guide-1').value, document.getElementById('guide-2').value];
              price = 20000;
              duration = document.getElementById('duration').value;
              maxGroupSize = document.getElementById('group-size').value;
              difficulty = document.getElementById('difficulty').value;
              description = document.getElementById('description').value;
              summary = document.getElementById('summary').value;
              imageCover = document.getElementById('photo').value;
              console.log({
                name: name,
